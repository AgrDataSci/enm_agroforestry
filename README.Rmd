...
Ensemble model outputs produced by the script "script/01_ensemble_modelling.R" are also too large to upload to GitHub (approx. 9 GB). If you want to use these files please open a request on the [issues](https://github.com/kauedesousa/enm_agroforestry/issues) section in this repository or via e-mail to the repository maintainer.
